...
/**
 * Activty for twitter authentication.
 * 
...
public class BuiltTwitterLoginActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.builtio_twitter_login_activity_);

		if(BuiltAppConstants.TWITTER_CONSUMER_KEY == null || BuiltAppConstants.TWITTER_CONSUMER_SECRET == null){
			RawAppUtils.showLog("BuiltTwitterLoginActivity", BuiltAppConstants.TWITTER_CONSUMER_KEY_SECRET_NULL);
			RawAppUtils.errorLog("BuiltTwitterLoginActivity",  BuiltAppConstants.TWITTER_CONSUMER_KEY_SECRET_NULL);
