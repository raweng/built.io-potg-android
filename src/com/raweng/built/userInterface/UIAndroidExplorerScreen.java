	...
	private void loadFileList() {
		try {
			...
			if (path.exists()) {
				...
				RawAppUtils.showLog(TAG, "path does not exist");
				RawAppUtils.errorLog(TAG, "path does not exist");
			}
			...
			adapter = new ArrayAdapter<Item>(this, R.layout.builtio_fileselect_row_inpicker, this.fileList) {
				...
				public View getView(int position, View convertView, ViewGroup parent) {
					...
					try {
						...
						RawAppUtils.showLog(TAG, "---------------loadFileList-catch|" + error);
			...
			RawAppUtils.showLog(TAG, "unable to write on the sd card");
			RawAppUtils.errorLog(TAG, "unable to write on the sd card");
