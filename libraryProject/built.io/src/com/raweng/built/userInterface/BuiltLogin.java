 ...
 * <br>
 * 
 * &#160;While using {@link BuiltLogin} class, user need to add {@link #setOnActivityResult(int, int, Intent)} function under onActivityResult() inside calling class.
 * 
 *<br><b>Example</b><br>
 *
 *
 *<pre class="prettyprint">
 * BuiltLogin builtloginObject = new BuiltLogin(context);<br>
 * setContentView(builtloginObject.getView());<br><br>
 * 
 * &#64;Override<br>
 * protected void onActivityResult(int requestCode, int resultCode, Intent data){
 * &#160;&#160;&#160;builtloginObject.setOnActivityResult(requestCode,resultCode,data);
 * }
 * </pre>
 * @author raw engineering, Inc
 *
 */
public class BuiltLogin{

	private static final String TAG = "BuiltLogin";
	...
	/**
	 * Provide Button object which will be used for {@link BuiltLogin} using {@link BuiltUser} method.
	 */
	public Button loginButton;

	/**
	 * Provide Button object which will be used to open {@link BuiltSignUp} Activity.
	 */
	public Button signUpButton;

	/**
	 * Provide Button object which will be used for Google Login using {@link BuiltUser} method.
	 */
	public Button googleLoginButton;

	/**
	 * Provide Button object which will be used for Twitter Login using {@link BuiltUser} method.
	 */
	public Button twitterLoginButton;

	/**
	 * Provide ImageView object which will be used for default Image Forgot Password.
	 */
	public ImageView forgetPasswordImageView;

	/**
	 * Provide EditText object which will be used for Tenant.
	 */
	...
	/**
	 * Provide ImageView object which will be used for close view.
	 */
	...
	/**
	 * Initialise {@link BuiltLogin} instance.
	 * 
	 * @param context
	 * 							set application context.
	 * <br><b>Example</b><br>
	 * <pre class="prettyprint">
	 *   BuiltLogin builtloginObject = new BuiltLogin(context);
	 * </pre>
	 */
	public BuiltLogin(Context context){
		try{
			this.loginContext 	      = context;
			this.loginActivityInstance= (Activity) context;

			LayoutInflater inflaterLayout= (LayoutInflater) loginContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);	
			loginView                    = inflaterLayout.inflate(R.layout.activity_login, null);

			tenantEditText 	             =  (EditText) loginView.findViewById(R.id.tenant);
			emailEditText 	             =  (EditText) loginView.findViewById(R.id.emailSignUp);
			passwordEditText             =  (EditText) loginView.findViewById(R.id.password);

			closeImageView               =  (ImageView) loginView.findViewById(R.id.closeLogo);
			logoImageView                =  (ImageView) loginView.findViewById(R.id.imageViewLogo);
			forgetPasswordImageView      =  (ImageView) loginView.findViewById(R.id.forgotpasswordImageView);

			signUpButton                 =  (Button) loginView.findViewById(R.id.signUpButton);
			loginButton 		         =  (Button) loginView.findViewById(R.id.loginInButton);
			googleLoginButton            =  (Button) loginView.findViewById(R.id.logInWithGoogle);
			twitterLoginButton			 =	(Button) loginView.findViewById(R.id.logInWithTwitter);
			...
			forgetPasswordImageView.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					if(email.isEmpty()){
						...
						alertDialog.setIcon(R.drawable.ic_alertclose)
	...
	/**
	 * This provide view for {@link BuiltLogin}.
	 *
	 * @return 
	 * 			provide loginView view,so user can set Layout. 
	 * 
	 * <br><b>Example</b><br>
	 * <pre class="prettyprint">
	 * setContentView(builtloginObject.getView());
	 * </pre>
	 */
	public View getView(){
		return loginView;	
	 ...
	 * </pre>
	 */
	public void loginWithBuiltUser(BuiltAuthResultCallBack callback){
	 ...
	 *  
	 */
	public void loginWithGoogle(BuiltAuthResultCallBack callback) {
		builtAuthCallBack = callback;
		if(error != null){  
	 ...
	 * <pre class="prettyprint">
	 * 
	 * <br>BuiltLogin builtLogin = new BuiltLogin(context);<br>
	 ...
	 *  
	 */
	public void loginWithTwitter(BuiltAuthResultCallBack callback){
		builtAuthCallBack = callback;
	 ...
	 * </pre>
	 */
	public boolean checkLoginFieldsValidation(){
	 ...
	 * <br><b>Example</b><br>
	 * <pre class="prettyprint">
	 * builtloginObject.setLogoImageView(R.drawable.ic_built,ScaleType.CENTER);
	 * </pre>
	 */
	 ...
	 * <br><b>Example</b><br>
	 * <pre class="prettyprint">
	 * builtloginObject.setCloseImageView(R.drawable.ic_built,ScaleType.CENTER);
	 * </pre>
	 */
	 ...
	 * <br><b>Example</b><br>
	 *<pre class="prettyprint">
	 *builtloginObject.setImageContentDescription("content description");
	 *</pre>
	 */
	 ...
	 * Only for provided login layout.<br>
	 ...
	 * <br><b>Example</b><br> 
	 * <pre class="prettyprint">
	 * builtloginObject.setMargin(imageviewObject,100,100,100,100);
	 * </pre>
	 */
	...
	/**
	 * Set Progress Dialog.
	 * show ProgressDialog while {@link #loginWithBuiltUser(BuiltAuthResultCallBack)} and {@link #loginWithGoogle(BuiltAuthResultCallBack)}. 
	 * 
	 * @param progressDialog
	 * 						progressDialog Object.
	 * <br><b>Example</b><br> 
	 * <pre class="prettyprint">
	 * builtloginObject.setProgressDialog(progressDialogObject);
	 * </pre>
	 */
		...
		if(BuiltAppConstants.REQUEST_CODE_RECOVER_FROM_AUTH == requestCode && data != null && loginContext != null){
			...
			if (builtAuthCallBack != null && data != null) {
				...
				if (data.getExtras().get("error_message") != null && data.getExtras().get("error_code") != null) {
					error.errorMessage(data.getExtras().getString("error_message"));
					error.errorCode(data.getExtras().getInt("error_code"));
				}else{
					error.errorMessage(data.getExtras().getString("error_message"));
				}
				builtAuthCallBack.onError(error);
	...
	private void forgotPassword(String email) {
		...
		user.forgotPassword(email, new BuiltResultCallBack() {
			...
			public void onSuccess() {
				...
				alertDialog = new AlertDialog.Builder(loginContext); 
				alertDialog.setIcon(R.drawable.ic_alertsuccess).setTitle(BuiltAppConstants.FORGOT_PASSWORD_ALERT)
			...
			public void onError(BuiltError error) {
				progressDialog.dismiss();
				alertDialog = new AlertDialog.Builder(loginContext); 
				alertDialog.setIcon(R.drawable.ic_alertclose).setTitle(BuiltAppConstants.FORGOT_PASSWORD_ALERT)
				.setMessage(error.errorMessage().toString()).create().show(); 
			}
