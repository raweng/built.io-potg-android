 ...
 * <b>Note :</b>
 * User needs to add following permissions in manifest.<br>
 ...
 * <br>
 * User can open sign up activity by passing intent.<br>
 * <pre class="prettyprint">
 * setSignUpIntent(signUpIntent);
 * </pre>
 * 
 * For twitter login user can set consumer key and consumer secret using {@link #setUpTwitter(String, String)}<br>
 * <pre class="prettyprint">
...
public abstract class BuiltUILoginController extends FragmentActivity{
	...
	/**
	 * Provide Button object which will be used for {@link BuiltUILoginController} using {@link BuiltUser} method.
	 */
	public Button loginButton;

	/**
	 * Provide Button object which will be used to open {@link BuiltUISignUpController} Activity.
	 */
	 ...
	 *<pre class="prettyprint">
	 *<br>&#160;&#160;&#160;&#160;@Override
	 *<br>&#160;&#160;&#160;&#160;public void loginSuccess(BuiltUser user) {<br>
	 * &#160;&#160;&#160;&#160;&#160;&#47;&#47;User can get Access tokens after success.
