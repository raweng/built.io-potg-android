...
public class ErrorReporter implements Thread.UncaughtExceptionHandler {
	...
	private String[] _recipients = new String[] { "android@raweng.com"};
	private String _subject = "Crash Report built.io Android";
	...
	public static String currentVersionNumber(Context a) {
		...
		try {
			PackageInfo pi = pm.getPackageInfo("com.raweng.utilities", PackageManager.GET_SIGNATURES);
