...
public class BuiltExtension {
	 ...
	 * 
	 * @param callback
	 * 					 {@link BuiltExtensionCallback} object to notify the application when the request has completed.
	 * 
	 */
	public static void execute(String logicId, HashMap<String, Object> properties, BuiltExtensionCallback callback) {
		try{
			if(logicId != null){
	...
	/**
	 * To cancel all {@link BuiltExtension} network calls.
	 */
	...
	private static void throwExeception(BuiltExtensionCallback callback, String errorMessage) {
